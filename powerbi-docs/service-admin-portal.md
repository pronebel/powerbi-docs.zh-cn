...
组织中的用户可以从磁贴或可视化效果导出数据。 详细了解如何[从磁贴或视觉对象导出数据](visuals/power-bi-visualization-export-data.md)。
...
有关详细信息，请访问[关于组织的自定义视觉对象的常见问题解答](/power-bi/developer/power-bi-custom-visuals-faq#organizational-power-bi-visuals)
...
| 孤立 | 无管理员用户的工作区。 |
| 已删除 | 已删除的工作区。 如果需要，我们保留了足够的元数据用于还原工作区。 |
