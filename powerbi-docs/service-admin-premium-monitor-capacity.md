...
此应用的当前版本是 1.9（2018 年 11 月 14 日发布）。
...
| **数据集工作负载** | * 过去七天内的刷新总次数<br> * 过去七天内的刷新成功总次数<br> * 过去七天内的刷新失败总次数<br> * 由于内存不足导致刷新失败的总次数<br> * 平均刷新持续时间是完成操作所需的时间（以分钟为单位）<br> * 平均刷新等待时间是计划时间与操作开始时间之间的平均延迟（以分钟为单位）<br> * 过去七天内查询运行的总次数<br> * 过去七天内查询成功的总次数<br> * 过去七天内查询失败的总次数<br> * 平均查询持续时间是完成操作所需的时间（以分钟为单位）<br> * 由于内存压力导致模型收回的总次数<br> * 数据集的平均大小 <br> * 加载到内存中的数据集的平均计数 |
|  |  |
