...
* 新功能区现在默认处于启用状态 [[视频]](https://youtu.be/DMjvJGGB_LQ?t=785) [[文章]](desktop-ribbon.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-march-2020-feature-summary/#_New_ribbon) 
...
* 增强的数据集元数据（预览）[[视频]](https://youtu.be/DMjvJGGB_LQ?t=1184) [[文章]](desktop-enhanced-dataset-metadata.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-march-2020-feature-summary/#_Enhanced_dataset_metadata) 
...
* 聚合（预览）[[视频]](https://youtu.be/Rzw2WyI09kY?t=11m37s) [[文章]](desktop-aggregations.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-september-2018-feature-summary/#aggregations) 
...
* 按值的条件格式设置 [[视频]](https://youtu.be/dgv5HhHxxe8?t=7m54s) [[文章]](desktop-conditional-table-formatting.md#color-by-color-values) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-august-2018-feature-summary/#conditionalFormatting) 
...
* 度量值钻取 [[视频]](https://youtu.be/-_GMCE1TLvQ?t=2m9s) [[文章]](desktop-drillthrough.md#pass-all-filters-in-drill-through) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-may-2018-feature-summary/#measureDrillthrough) 
...
-   书签（预览）[[视频]](https://youtu.be/jksjtR8GnBE?t=1m47s) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-october-2017-feature-summary/#bookmarking) [[文章]](desktop-bookmarks.md)
...
-   辅助功能改进 [[视频]](https://youtu.be/moTQJlnClJw?t=27m25s) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-september-2017-feature-summary/#accessibility) [[文章]](desktop-accessibility.md)
    -   可访问查看数据 [[视频]](https://youtu.be/moTQJlnClJw?t=29m40s) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-september-2017-feature-summary/#accessibleData) [[文章]](desktop-accessibility.md)
...
-   高密度散点图采样 [[视频]](https://youtu.be/moTQJlnClJw?t=30m22s) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-september-2017-feature-summary/#highDensityScatter) [[文章]](desktop-high-density-scatter-charts.md)
...
-   Azure 使用见解连接器 [[视频]](https://youtu.be/moTQJlnClJw?t=44m57s) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-september-2017-feature-summary/#azureConsumptionInsights) [[文章]](desktop-connect-azure-consumption-insights.md)
...
-   快速度量 [[视频]](https://youtu.be/AWMaIaI8G2Y?t=3m43s) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-april-feature-summary/#quickMeasures) [[深入博客]](https://powerbi.microsoft.com/blog/quick-measures-preview/) [[文章]](desktop-quick-measures.md)
...
-   更新的钻取行为 [[文章]](desktop-inline-hierarchy-labels.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-september-feature-summary/) [[视频]](https://youtu.be/pcUr6E8g_KI?t=5m6s)


### <a name="analytics"></a>分析

-   预测（预览版）[[文章]](desktop-analytics-pane.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-september-feature-summary/) [[视频]](https://youtu.be/pcUr6E8g_KI?t=6m6s)
...
-   新的数据连接器：
    ...
    -   ProjectPlace 连接器 [[文章]](desktop-connect-impala.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-september-feature-summary/)
-   现有连接器的改进：
    ...
    -   SAP Business Warehouse和 SAP HANA 连接器 - 参数输入接口增强功能 [[文章]](desktop-sap-bw-connector.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-september-feature-summary/)
...
-   内联层次结构的正式发布 [[文章]](desktop-inline-hierarchy-labels.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-august-feature-summary/) [[视频]](https://youtu.be/0VvG7Eqoke8?t=4m6s)
...
-   所有新的分析 [[文章]](desktop-analytics-pane.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-august-feature-summary/) [[视频]](https://youtu.be/0VvG7Eqoke8?t=8m22s) 
...
-   现有连接器的改进：
    -   Impala 连接器 - DirectQuery 支持 [[文章]](desktop-connect-impala.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-august-feature-summary/)
    ...
    -   SAP Business Warehouse 连接器的正式发布 [[文章]](desktop-sap-bw-connector.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-august-feature-summary/)
...
-   新的数据连接器：
    -   Amazon Redshift [[文章]](desktop-connect-redshift.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-july-feature-summary/)
    -   Impala [[文章]](desktop-connect-impala.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-july-feature-summary/)
-   现有连接器的改进：
    ...
    -   SAP Business Warehouse 连接器的改进和变化 [[文章]](desktop-sap-bw-connector.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-july-feature-summary/)


### <a name="query-editor-improvements"></a>查询编辑器改进：

-   在查询编辑器中使用 R 脚本 [[文章]](desktop-r-in-query-editor.md) [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-july-feature-summary/) 
-   查询参数增强：
...
-   行级别安全性 [[博客]](https://powerbi.microsoft.com/blog/power-bi-desktop-june-update/) [[文章]](desktop-rls.md)
...
-   可自定义的工具提示 [[视频]](https://youtu.be/KnDs4amt9-c?t=172) [[文章]](desktop-custom-tooltips.md)
-   表格中的条件格式设置 [[视频]](https://youtu.be/KnDs4amt9-c?t=313) [[文章]](desktop-conditional-table-formatting.md)
...
想了解有关这些更新的详细信息？ 请查看[博客文章](https://blogs.msdn.com/b/powerbi/archive/2016/01/28/power-bi-updates-this-week-new-report-authoring-capabilities.aspx)，你可以在其中获取有关上述每项新增功能的更为详细的信息。
...
-   [Power BI Desktop 中的 R 视觉对象集成（预览功能）](desktop-r-visuals.md)
...
-   [SSAS 多维支持 - 层次结构支持](desktop-ssas-multidimensional.md)
-   Stripe 连接器
-   Smartsheet 连接器
-   **输入数据**：粘贴或输入数据以创建表格
...
想了解有关这些更新的详细信息？ 请查看[博客文章](https://blogs.msdn.com/b/powerbi/archive/2015/12/16/more-power-bi-feature-updates-power-bi-desktop-december-update-and-new-power-bi-service-features.aspx)，你可以在其中获取有关上述每项新增功能的更为详细的信息。
...
-   [SSAS 多维支持](desktop-ssas-multidimensional.md)
-   [SAP Hana](desktop-sap-hana.md)
-   [R 脚本](desktop-r-scripts.md)
...
想了解有关这些更新的详细信息？ 请查看[博客文章](https://blogs.msdn.com/b/powerbi/archive/2015/11/20/announcing-the-power-bi-desktop-november-update.aspx)，你可以在其中获取有关上述每项新增功能的更为详细的信息。
...
有关详细信息，[请查看博客公告](https://blogs.msdn.com/b/powerbi/archive/2015/10/20/custom-visualizations-support-and-22-other-features-in-the-power-bi-desktop-october-update.aspx)，该公告介绍了上述每项更新的更为详细的信息。
...
有关此更新的详细信息，[请查看博客公告](https://blogs.msdn.com/b/powerbi/archive/2015/09/23/44-new-features-in-the-power-bi-desktop-september-update.aspx)，该公告介绍了上述每项更新的更为详细的信息。
