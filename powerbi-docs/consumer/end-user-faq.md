...
可以直接购买或者通过在 [www.powerbi.com](https://www.powerbi.com) 与代表聊天的方式购买 Power BI Pro 许可证。
...
在 [Microsoft 信任中心](https://go.microsoft.com/fwlink/?LinkId=785324)了解有关 Power BI 合规性的详细信息。
