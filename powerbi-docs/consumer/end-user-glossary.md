...
**内容包** 预打包的数据集、报表和仪表板的集合。 现在为**应用**，了解[新工作区体验](https://docs.microsoft.com/power-bi/service-create-the-new-workspaces)。 
...
**Premium 工作区** 在专用容量中运行的工作区，使用钻石图标向客户表示。  
