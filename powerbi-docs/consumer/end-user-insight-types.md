...
![一组见解](media/end-user-insight-types/power-bi-insight-line.png)
...
### <a name="outliers"></a>离群值
这种见解类型使用聚类分析模型来查找非时序数据中的离群值。 当特定类别的值明显不同于其他类别时会检测到离群值。

![离群值示例](./media/end-user-insight-types/power-bi-outliers.png)
