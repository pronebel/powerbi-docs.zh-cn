...
- 在 Power BI 社区[数据案例库](https://community.powerbi.com/t5/Data-Stories-Gallery/Sales-amp-Returns-Sample-Report/m-p/876607)中查看此报表，并与之交互。
...
- 在 Power BI 服务中安装[内置内容包](#install-built-in-content-packs)。
