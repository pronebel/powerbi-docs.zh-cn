...
:::image type="content" source="media/desktop-excel-stunning-report/power-bi-two-ways-load-data.png" alt-text="使用示例数据 > 加载数据的两种方法的屏幕截图。":::
...
1. 选择“在 Power BI 中打开‘你的文件名’”。
    ...
    :::image type="content" source="media/desktop-excel-stunning-report/power-bi-excel-report-service.png" alt-text="Power BI 服务中已完成的 Power BI 报表的屏幕截图。"::: 
