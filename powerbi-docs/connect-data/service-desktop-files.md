...
使用 Power BI Desktop 中的“发布”效果与使用 Power BI 中的“获取数据”相同，都可导入本地驱动器上的文件或连接到 OneDrive 上的文件。  下面介绍了快速操作方法，但也可参阅[从 Power BI Desktop 发布](../create-reports/desktop-upload-desktop-files.md)以了解详细信息。
