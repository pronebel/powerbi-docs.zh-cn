...
如果想要详细了解安全设置，可在[此处](./desktop-connector-extensibility.md)了解详细信息。
...
如果有需要你或开发人员签名的连接器，可以在[这些](/power-query/handlingconnectorsigning) Power Query 文档中了解相关信息。