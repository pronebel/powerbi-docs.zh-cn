---
title: Azure 中 Power BI Embedded 服务的诊断日志记录，用于实现 Power BI 嵌入式分析嵌入式 BI 解决方案
description: 了解如何在 Azure 中根据 Power BI 嵌入式分析的嵌入式 BI 解决方案设置 Power BI Embedded 服务的诊断日志记录。
author: KesemSharabi
ms.author: kesharab
ms.reviewer: ''
ms.service: powerbi
