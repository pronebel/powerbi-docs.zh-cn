---
title: Power BI 嵌入式分析中用于增强嵌入式 BI 见解的 Power BI 视觉对象
description: 本文介绍如何自定义 Power BI 视觉对象。 使用 Power BI 嵌入式分析改进嵌入式 BI 见解。
author: KesemSharabi
ms.author: kesharab
manager: rkarlin
ms.reviewer: ''
...
:::image type="content" source="media/power-bi-custom-visuals/power-bi-visualizations.png" alt-text="Power BI Desktop 和 Power BI 服务中显示的“Power BI 可视化”窗格的屏幕截图。":::
