...
**Power BI 服务**有一个可供美国政府客户使用的版本，作为 **Office 365 美国政府社区**订阅的一部分。 **Power BI 服务**本文中讨论的版本专为美国政府客户，独立且不同于的商业版本**Power BI 服务**。
...
7. 登录到**Power BI 服务**为美国政府客户 [https://app.powerbigov.us](https://app.powerbigov.us)
...
若要将租户*列入允许列表*美国政府版云，请联系 Microsoft 帐户团队的允许列表的帮助。 只有管理员才能发出此请求。 *列入允许列表* 的过程大约需要三个星期，在此期间，Power BI 工程团队将作出适当更改以确保你的租户可在美国政府版云中正常运行。
...
* 任何免费版许可证用户将不再能够登录到 Power BI 使用**Power BI Desktop**，并且将会遇到以下部分所述的功能差距。
