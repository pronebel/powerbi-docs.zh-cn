...
**有关实时决策和强化客户联系的数据驱动见解**  
演讲者：Shruti Shukla 和 Chandra Stevens  
[立即观看](https://info.microsoft.com/ww-Landing-DataDrivenInsights.html)

**使用 Power BI 快速启动和运行**  
作者：Miguel Martinez，Microsoft  
[立即观看](https://info.microsoft.com/ww-landing-get-up-and-running-quickly-with-power-bi.html)

**使用 Power BI 和 Microsoft Teams 推动远程数据文化**  
作者：Lukasz Pawlowski  
[立即观看](https://info.microsoft.com/ww-Landing-RemoteDataCulturePowerBIandMicrosoftTeams.html)

**另请参阅：使用 Power BI 的 Excel 用户可以获得的 5 个优势**  
作者：Miguel Martinez 和 Carlos Otero  
[立即观看](https://info.microsoft.com/ww-Landing-FiveBenefitsExcelUsersWillGetFromUsingPowerBI-Webinar.html)

**使用 Microsoft Power BI 实时监视数据**  
作者：Miguel Martinez 和 Peter Myers  
[立即观看](https://info.microsoft.com/ww-landing-Monitor-Your-Data-in-Real-time-with-Microsoft-Power-BI.html)

**利用 Dremio 加速 Azure Data Lake Storage 上的 Power BI**  
作者：Chris Webb 和 Tomer Shiran [立即观看]( https://info.microsoft.com/ww-landing-Accelerate-Power-BI-on-Azure-Data-Lake-Storage-with-Dremio.html)

**使用 Power BI 和 Snowflake 生成可缩放的 BI 解决方案**  
作者：Chris Webb、Craig Collier 和 Chris Holliday  
[立即观看](https://info.microsoft.com/ww-landing-build-scalable-BI-solutions-using-power-BI-and-snowflake.html)

**利用管理 BI 内容的最佳做法，提高用户满意度**  
作者：Nimrod Shalit  
[立即观看](https://info.microsoft.com/ww-landing-Boost-User-Satisfaction-with-Best-Practices-for-Managing-BI-Content.html)

从见解到操作：**使用 Power BI 推动数据区域性**  
作者：Arun Ulagaratchagan 和 Amir Netz  
[立即观看]( https://info.microsoft.com/ww-landing-From-Insight-to-Action-Driving-a-Data-Culture-with-Power-BI.html)

使用 Power BI Embedded 进行更好地分析  
作者：Alon Baram  
[立即观看](https://info.microsoft.com/ww-landing-Enable-Better-Analytics-with-Power-BI-Embedded.html)

迈阿密热火队如何使用 Power BI 推动业务决策  
作者：Edson Crevecoeur、Frank Mesa 和 Xinrou Tan  
[立即观看]( https://info.microsoft.com/ww-Landing-How-the-Miami-HEAT-Used-Power-BI-to-Drive-Business-Decisions.html)

通过 Power BI 简化大数据准备和分析  
作者：Priya Sathy  
[立即观看](https://info.microsoft.com/ww-landing-simplify-big-data-prep-and-analysis-with-power-BI.html)

利用 Power BI 改进决策制定  
作者：Kim Manis 和 Lukasz Pawlowski  
[立即观看](https://info.microsoft.com/ww-Landing-Improve-Decision-Making-with-Power-BI.html)
...
[立即观看]( https://info.microsoft.com/ww-landing-Explore-the-Total-Economic-Impact-Of-Microsoft-Power-BI.html)
...
[注册并立即观看](https://info.microsoft.com/ww-landing-How-Microsoft-Is-Changing-BI-Data-Protection.html)

**如何成为见解驱动企业**  
作者：Microsoft 的 Amir Netz 和 Forrester 的 Boris Evelson  
[注册并立即观看](https://info.microsoft.com/ww-landing-how-to-become-an-insights-driven-business.html)

**AI 改变 BI 的三种方式**  
作者：Justyna Lucznik  
[注册并立即观看](https://info.microsoft.com/ww-landing-Three-Ways-AI-Is-Changing-BI.html&ocid=mkto_eml_EM581230A1LA1)

**Power BI 与现代企业 BI 的未来**  
作者：Arun Ulag 和 Amir Netz  
[注册并立即观看](https://info.microsoft.com/ww-landing-The-Future-of-Modern-and-Enterprise-BI-video.html)

**塑造大数据分析未来的九大趋势**  
作者：Vijay Gopalakrishnan  
[注册并立即观看](https://info.microsoft.com/ww-landing-Nine-Trends-Shaping-the-Future-of-Big-Data-Analytics.html)
...
**Power BI 移动版应用入门**  
作者：Maya Shenhav  
[注册并立即观看](https://info.microsoft.com/ww-Landing-Getting-Started-with-the-Power-BI-Mobile-App-Video.html)
...
作者：Kevin Horlock  
[注册并立即观看](https://info.microsoft.com/ww-landing-Using-Power-BI-with-Dynamics-365-Finance-and-Operations.html)
...
[注册并立即观看](https://info.microsoft.com/Microsoft-Runs-on-Power-BI-Using-Power-BI-in-Modern-Treasury-Registration.html)
...
作者：Nimrod Shalit  
[注册并立即观看](https://info.microsoft.com/ww-landing-PBI-webinar-Best-Practices-for-Managing-Power-BI-Embedded-video.html)
...
[注册并立即观看](https://info.microsoft.com/How-to-Get-insights-from-Your-Workday-HR-Data-Registration.html)
...
[注册并立即观看](https://info.microsoft.com/Transform-Your-Customer-Data-into-Retail-Success-OnDemandRegistration.html?wt.mc_id=undefined)
...
[注册并立即观看](https://info.microsoft.com/ww-landing-5-Habits-of-a-Successful-Trend-Curator-Video.html)
