...
2.  如果在 Premium Gen2 上使用 XMLA，请确保使用的是[数据建模和管理工具](service-premium-connect-tools.md#data-modeling-and-management-tools)的最新版本。 

3.  只有最新的客户端库支持 Premium Gen2 中的 Analysis services 功能。 支持此要求的相关工具的预计发布日期如下：
