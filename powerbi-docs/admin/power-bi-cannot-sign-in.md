...
向 Microsoft 支持部门请求帮助的另一种方式为购买 [Microsoft 顶级支持](https://support.microsoft.com/premier)。 如果你知道组织购买了 Microsoft 顶级支持，但仍无法通过任何 Power BI 频道或 Office 支持创建案例，可以拨打以下号码联系顶级支持部门：
