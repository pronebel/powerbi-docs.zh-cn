...
![“选项”对话框的屏幕截图。](media/desktop-privacy-levels/desktop_privacylevels1.png)
...
![“数据源设置”对话框的屏幕截图。](media/desktop-privacy-levels/desktop_privacylevels2.png)
...
“隐私级别”在默认情况下设置为“根据每个源的隐私级别设置合并数据”，这表示将强制实施“隐私级别”  。
