...
在深入探讨创建上述二者之一前，最好牢固掌握用于表和列的 DAX 语法，你将在创建计算列或度量值时使用它。
...
## <a name="creating-measures"></a>创建度量值
计算百分比或比率，或者需要复杂的聚合时，请使用度量值。 若要创建使用 DAX 公式的度量值，请从“建模”选项卡选择“新建度量值”按钮。同样，最好采用 Power BI Desktop 的“数据”视图，因为它显示“编辑栏”并使写入 DAX 公式更加容易。
