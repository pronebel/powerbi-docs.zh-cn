...
租户是组织在注册 Azure、Microsoft Intune、Power BI 或 Microsoft 365 等 Microsoft 云服务时接收并拥有的 Azure AD 服务的专用实例。 各个 Azure AD 租户各不相同，相互独立。
