...
| 白皮书 | 说明 | Date |
| --- | --- | --- |
| [规划 Power BI Enterprise 部署](https://aka.ms/PBIEnterpriseDeploymentWP) |此更新技术白皮书概述了一种安全可靠的组织 Power BI 部署的注意事项和最佳实践。 | 2020 年 6 月 |
...
| [SQL Server 2016 Analysis Services 中的 DirectQuery](/archive/blogs/analysisservices/directquery-in-sql-server-2016-analysis-services-whitepaper) |针对 SQL Server 2016，DirectQuery 经过重新设计，显著提高了速度和性能，但现在的理解和实现过程也更为复杂。 | 2017 年 1 月 |
