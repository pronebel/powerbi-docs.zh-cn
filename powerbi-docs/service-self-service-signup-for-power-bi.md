...
本文将介绍注册并开始使用 Power BI 服务的多种方式。 若要详细了解 Power BI 许可证类型之间的功能差异，请参阅[按许可证类型划分的 Power BI 功能](service-features-license-type.md)。
...
> [!NOTE]
> 你可以使用 .gov 或 .mil 地址注册 Power BI。 相关信息，请查看[在 Power BI 服务中注册你的美国政府组织](https://docs.microsoft.com/power-bi/service-govus-signup)。
>

> [!NOTE]
> 注册之后，可以[邀请来宾用户](https://docs.microsoft.com/azure/active-directory/active-directory-b2b-what-is-azure-ad-b2b)使用包括个人帐户在内的任何电子邮件地址来查看你 Power BI 租户中的内容。
>
...
> [!NOTE]
> 如果你收到一条注明“我们已经认识你”的消息，请尝试导航到 [https://app.powerbi.com](https://app.powerbi.com) 并登录。
> 
> 
...
7. 然后转到 [https://app.powerbi.com](https://app.powerbi.com) ，你可以作为免费用户开始使用 Power BI。
