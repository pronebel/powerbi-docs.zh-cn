...
6. 导航到视觉对象文件保存的位置，然后选择该文件。 Power BI Desktop 自定义可视化效果具有 .pbivisual 扩展名。
...
如果你创建自己的 R 视觉对象以供在报表中使用，则可以向自定义视觉对象库提供你的自定义视觉对象，从而与全世界共享你的视觉对象。 通过 GitHub 进行贡献，相应过程在以下位置有所讲述：
