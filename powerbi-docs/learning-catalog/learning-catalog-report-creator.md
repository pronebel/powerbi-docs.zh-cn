...
| 内容 | 说明  | 格式 | 长度   |
|-------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|----------------|
| [使用 Power BI 创建和使用分析报表](https://docs.microsoft.com/learn/paths/create-use-analytics-reports-power-bi/)  | 此学习路径介绍了 Power BI，并示范了如何使用和生成商业智能报表。  | 免费自定进度在线学习路径 | 6 小时 22 分钟      |
| [为 Power BI 准备数据](https://youtu.be/l2wy4XgQIu0)  | 观看几个为 Power BI 准备 Excel 数据的简单提示。 | 1 分钟 20 秒      |
...
| [PowerBI.Tips 所有者主讲的 Power 技巧、提示和工具](https://www.youtube.com/watch?v=fnj1_e3HXow) | 在这场非常特别的用户组网络研讨会中，PowerBI.Tips 的所有者和作为 Power BI MVP 的 Seth Baur 和 Mike Carlo 将分享他们过去 18 个月发布到 http://PowerBI.Tips 的关于 Power 技巧、提示和工具的大量内容  | YouTube 视频  | 1 小时 7 分钟 40 秒 |
